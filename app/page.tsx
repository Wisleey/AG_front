  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <section className="hero-gradient relative min-h-screen flex items-center justify-center">
        ...
        <div
          className="absolute bottom-20 left-10 w-96 h-96 bg-brand-600/10 rounded-full blur-3xl animate-float"
        ...
        <div className="section-container relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            {/* Subtítulo */}
            <p
              className="text-xl md:text-2xl text-neutral-300 mb-12 max-w-3xl mx-auto animate-fade-in-up"
              style={{ animationDelay: "0.2s" }}
            >
              Digitalize e automatize a gestão do seu grupo de networking.
              Gestão completa de membros, reuniões e indicações em uma
              plataforma moderna.
            </p>
            ...
            {/* Stats */}
            <div
              className="grid grid-cols-3 gap-8 max-w-4xl mx-auto pt-12 border-t border-dark-300 animate-fade-in"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="stagger-item group card-modern p-8 hover-glow">
              ...
              <p className="text-neutral-400 leading-relaxed">
                Cadastro completo, perfis detalhados, status e permissões
            ...
            <div className="stagger-item group card-modern p-8 hover-glow">
              ...
              <p className="text-neutral-400 leading-relaxed">
                Geração e acompanhamento completo de negócios com métricas de
            ...
            <div className="stagger-item group card-modern p-8 hover-glow">
              ...
              <p className="text-neutral-400 leading-relaxed">
                Métricas e KPIs em tempo real com visualizações modernas para
      ...
      <section className="section-container relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-brand-500/20 to-brand-400/20 blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="gradient-border p-12 md:p-16">
            ...
            <Link href="/intencao">
              <Button
                size="lg"
                className="bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-400 hover:to-brand-500 text-white px-10 py-5 rounded-full text-xl font-semibold shadow-xl hover:shadow-brand-500/50 transition-all hover:scale-105 pulse-glow"
              >
                Começar Agora
              </Button>
            </Link>
      ...
      <footer className="border-t border-dark-300 py-12">
        <div className="container mx-auto px-4 text-center">
          <p className="text-neutral-500 text-sm">
            Desenvolvido com Next.js, TypeScript e PostgreSQL | Wisley Rodrigues
          </p>
        </div>
      </footer>
    </main>
